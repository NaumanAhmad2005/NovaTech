...
import { Bell, Search, Command, User, Settings } from "lucide-react";
...
export default function AdminTopbar() {
  ...
  return (
    <header className="h-16 px-6 flex items-center justify-between border-b border-white/5 bg-[#050816]/80 backdrop-blur-md sticky top-0 z-30">
